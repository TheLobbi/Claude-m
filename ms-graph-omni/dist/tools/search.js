...
export const search_query = makeTool({
    name: "search_query",
    description: "Run a unified Microsoft Search query across one or more entity types: 'driveItem' (files), 'message' (mail), 'event' (calendar), 'site', 'list', 'listItem', 'chatMessage', 'person', 'externalItem'. " +
    ...
    inputSchema: z.object({
        ...
        entityTypes: z
            ...
            .min(1)
            .describe("Required. Pick a Graph-valid combination (see description). No default is provided — the prior default ['driveItem','message','event'] violates the compatibility matrix and would fail every call."),
