...
export const entra_listConditionalAccessPolicies = makeTool({
    ...
    mode: "app",
    inputSchema: ListOptionsSchema,
    call: async (opts, client) => applyListOptions(client.api("/identity/conditionalAccess/policies"), opts).get(),
});
export const entra_getConditionalAccessPolicy = makeTool({
    ...
    call: async ({ policyId }, client) => client.api(`/identity/conditionalAccess/policies/${policyId}`).get(),
});
...
export const entra_listAuthenticationMethodConfigurations = makeTool({
    ...
    call: async (_input, client) => client.api("/policies/authenticationMethodsPolicy/authenticationMethodConfigurations").get(),
});
...
export const entra_listRoleAssignments = makeTool({
    ...
    mode: "app",
    inputSchema: ListOptionsSchema,
    call: async (opts, client) => applyListOptions(client.api("/roleManagement/directory/roleAssignments"), opts).get(),
});
// ============================================================ Licenses
