...
export const exchange_listAcceptedDomains = makeResourceTool({
    ...
    description: "List Exchange Online accepted domains through the Exchange admin REST surface used by app-only Exchange automation.",
    namespace: "exchange",
    resource: EXCHANGE_RESOURCE,
    baseUrl: EXCHANGE_RESOURCE,
    inputSchema: z.object({}),
    call: async (_input, client, tenant) => client.get(`/adminapi/beta/${tenant.tenantId}/AcceptedDomain`),
});
export const exchange_listTransportRules = makeResourceTool({
    ...
    baseUrl: EXCHANGE_RESOURCE,
    inputSchema: z.object({}),
    call: async (_input, client, tenant) => client.get(`/adminapi/beta/${tenant.tenantId}/TransportRule`),
});
export const exchange_listSharedMailboxes = makeResourceTool({
    ...
    baseUrl: EXCHANGE_RESOURCE,
    inputSchema: z.object({}),
    call: async (_input, client, tenant) => client.get(`/adminapi/beta/${tenant.tenantId}/Mailbox`, {
