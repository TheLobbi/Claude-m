...
import { fingerprintInput, isWriteTool, newCorrelationId, writeAuditEntry, } from "./auditLog.js";
export async function withObservability(ctx, fn) {
    ...
    try {
        ...
        logger.info({ tool: ctx.toolName, correlationId, durationMs, outcome: "ok", mode: ctx.mode }, "tool call completed");
        if (audit) {
            const entry = {
...
//# sourceMappingURL=latencyMiddleware.js.map