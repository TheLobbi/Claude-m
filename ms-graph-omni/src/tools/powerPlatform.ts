...
export const powerPlatform_listEnvironments = makeResourceTool({
  ...
  call: async (_input, client) =>
    client.get("/providers/Microsoft.BusinessAppPlatform/scopes/admin/environments", {
...
export const powerPlatform_listDlpPolicies = makeResourceTool({
  ...
  inputSchema: z.object({}),
  call: async (_input, client) =>
    client.get("/providers/Microsoft.BusinessAppPlatform/scopes/admin/policies", {
      "api-version": BAP_API_VERSION,
    }),
});
...
export const powerApps_listApps = makeResourceTool({
  ...
  call: async ({ environmentName }, client) =>
    client.get(`/providers/Microsoft.BusinessAppPlatform/scopes/admin/environments/${environmentName}/apps`, {
      "api-version": BAP_API_VERSION,
    }),
});
...
export const powerAutomate_listFlows = makeResourceTool({
  ...
  description:
    "List Power Automate flows in a Power Platform environment. Service principal support is limited to administrative scenarios.",
  namespace: "power-platform",
  resource: BAP_RESOURCE,
  baseUrl: BAP_BASE,
  inputSchema: z.object({ environmentName: z.string() }),
  call: async ({ environmentName }, client) =>
    client.get(`/providers/Microsoft.ProcessSimple/scopes/admin/environments/${environmentName}/flows`, {
      "api-version": "2016-11-01",
    }),
});

function dataverseOrigin(environmentUrl: string): string {
...
export const dataverse_listTables = makeResourceTool({
  ...
  call: async (_input, client) =>
    client.get("/api/data/v9.2/EntityDefinitions", {
