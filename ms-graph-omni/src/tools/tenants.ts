...
import {
  effectiveCapabilityPacks,
  enabledNamespaces,
  prerequisitesForPacks,
  requiredResourcesForPacks,
} from "../capabilities.js";

export const tenant_list: ToolDef<Record<string, never>> = {
  name: "tenant_list",
  description:
    "List the Microsoft 365 tenants this MCP server is configured to access. " +
