...
export const intune_listManagedDevices = makeTool({
  ...
  call: async (opts, client) =>
    shapeListResponse(await listRequest(client, "/deviceManagement/managedDevices", opts).get()),
});
...
export const intune_listMobileApps = makeTool({
  ...
  inputSchema: ListOptionsSchema,
  call: async (opts, client) =>
    shapeListResponse(await listRequest(client, "/deviceAppManagement/mobileApps", opts).get()),
});
...
export const intune_listCompliancePolicies = makeTool({
  ...
  inputSchema: ListOptionsSchema,
  call: async (opts, client) =>
    shapeListResponse(await listRequest(client, "/deviceManagement/deviceCompliancePolicies", opts).get()),
});
...
export const intune_listConfigurationProfiles = makeTool({
  ...
  inputSchema: ListOptionsSchema,
  call: async (opts, client) =>
    shapeListResponse(await listRequest(client, "/deviceManagement/deviceConfigurations", opts).get()),
});
